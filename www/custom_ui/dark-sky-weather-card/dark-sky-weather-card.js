/** https://community.home-assistant.io/t/custom-dark-sky-animated-weather-card/59816/102 **/
class DarkSkyWeatherCard extends HTMLElement {
  set hass(hass) {
    if (!this.content) {
      ...
      link.type = 'text/css';
      link.rel = 'stylesheet';
      link.href = '/local/custom_ui/dark-sky-weather-card/dark-sky-weather-card.css';
